...
export default function HealthTipsScreen() {
  ...
  // Render messages for web using ScrollView
  const renderMessagesForWeb = () => (
    <ScrollView
      ref={scrollViewRef}
      style={styles.messagesContainer}
      contentContainerStyle={styles.webMessagesContentContainer}
  ...
  // Render messages for mobile using FlatList
  const renderMessagesForMobile = () => (
    <FlatList
      ref={flatListRef}
      data={messages}
      renderItem={renderMessage}
  ...
  if (viewMode === 'tips') {
    return (
      <View style={styles.container}>
        ...
        {Platform.OS === 'web' ? (
          <ScrollView 
            style={styles.webTipsContainer}
            contentContainerStyle={styles.webTipsContentContainer}
            showsVerticalScrollIndicator={true}
          >
            {tips.map((item) => (
  ...
  return (
    ...
    >
      ...
      {/* Chat Messages - Different rendering for web vs mobile */}
      {Platform.OS === 'web' ? renderMessagesForWeb() : renderMessagesForMobile()}
